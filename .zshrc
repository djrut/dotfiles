...
alias gl='git --no-pager log --pretty=oneline --decorate -n32'
alias gll='git --no-pager log --pretty=format:"%C(yellow)%h%Creset %C(red)%H%Creset %C(green)%cd%Creset %C(bold blue)%an%Creset%C(auto)%d%Creset %s" --date=short -n32'
